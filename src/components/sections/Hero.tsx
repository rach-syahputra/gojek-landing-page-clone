export default function Hero() {
  return (
    <div className="relative h-[600px] w-full bg-[url('/hero.jpg')] bg-center bg-no-repeat md:bg-cover xl:h-[800px]">
      <div className='absolute left-0 top-0 h-full w-full bg-black bg-opacity-10'></div>
      <div className='mx-auto flex h-full w-2/3 flex-col justify-end py-[60px] md:justify-center lg:w-3/4'>
